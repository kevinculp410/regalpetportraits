  ...
  return `
    ...
    <footer style="background-color:#8b5cf6;color:#fff;padding:16px 0;margin-top:16px;">
      <div class="container" style="display:flex;justify-content:space-between;align-items:center;gap:12px;font-size:12px;">
        <div>
          CopyRight 2025 @<a href="https://www.BlueSkyAiAutomation.com" style="color:#fff;text-decoration:underline;">BlueSkyAiAutomation</a>
        </div>
        <div style="display:flex;gap:12px;align-items:center;">
          <a href="mailto:support@regalpetportraits.com" style="color:#fff;text-decoration:underline;">support@regalpetportraits.com</a>
